...
public class AtencionApoderadoMapper {
    ...
    public static AtenApoderadoListDto toListAtenApoderado(Apoderado apoderado){
        return new AtenApoderadoListDto(apoderado.getId(), PersonaMapper.toConcatNombre(apoderado.getPersona()), apoderado.getPersona().getTdocumento(),
                apoderado.getPersona().getNdocumento(),apoderado.getPersona().getTelefono1(), apoderado.getPersona().getTelefono2());
    }
    ...
    public static AtenApoderadoDto toDto(AtencionApoderados entity){
        return new AtenApoderadoDto( entity.getMotivo(), entity.getResumen(), entity.getResumen(), entity.getConclusiones(), entity.getIntervencion()
