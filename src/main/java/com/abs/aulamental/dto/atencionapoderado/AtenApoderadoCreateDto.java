...
@Valid
public record AtenApoderadoCreateDto(
        @NotNull(message = "El id del apoderado no puede ser nulo") int idpsicologo,
        @NotNull(message = "El id del apoderado no puede ser nulo") int idApoderado,
